...
\begin{listing}[H]
	\begin{minted}[frame=lines,rulecolor=MidnightBlue,bgcolor=LGray,fontsize=\footnotesize ,breaklines]{julia}
	julia> ] add NumNN
	julia> using NumNN
	\end{minted}
