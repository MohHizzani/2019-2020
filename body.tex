...
\begin{table}[H]
	...
	\begin{tabular}{|c | c | c || c | c |}
		...
		%%%%%%%%%% Benchmark 2
		\multirow{14}{*}{Benchmark 2} & \multirow{5}{*}{Float32} & Train Accuracy & 0.8731 & 0.9160\\
		...
		%%%%%%%%%% Benchmark 3
		\multirow{14}{*}{Benchmark 3} & \multirow{5}{*}{Float32} & Train Accuracy & 0.8864 & 0.9072\\
		& & Test Accuracy & 0.8730 & 0.8899\\
		& & Train Cost & 0.3076 & 0.2527\\
		& & Test Cost & 0.3547 & 0.3050\\
		& & Training Time / Sample & $3.07m$s & $14m$s\\\cline{2-5}
